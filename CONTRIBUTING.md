# Contributing to `gardener-extension-runtime-kata`

Welcome and thank you for making it this far and considering contributing to `gardener-extension-runtime-kata`.
...
For major changes, API changes or features please open an [Issue](https://github.com/stackitcloud/gardener-extension-runtime-kata/issues)
